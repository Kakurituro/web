...
function NoticeInfo({ playerId }: RoleInfoProps) {
  ...
  return (
    <>
      ...
      <div className="w-[80svw] h-[23svh] bg-white mt-[2svh] rounded-[6px] shadow-[2.4px_2.9px_3px_rgba(128,128,128,0.2)] p-[5svw] flex items-center justify-center">
        <div className="font-MoboBold text-black text-[2.2svh] text-center">
        ...
        <div className="flex flex-col items-center justify-end pb-[7svh] h-[100svh]">
          ...
          <div onClick={handleNext}>
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
            >
              <p className="text-white text-[1.7svh]">はい</p>
            </motion.div>
          </div>
        </div>
      )}
